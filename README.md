...
<sub>${\text{\color{#FAF066} ❝　\color{#FADC66} 𝗬ou \color{#FABF66} 𝙖𝙧𝙚 \color{#FAAE66}Shinichi \color{#FCA049}Izumi-Kun, \color{#FC7F49} right\color{#FC6149} ? . . .　\color{#ED3434}ㅤ❞}}$ <br>
...
<sub>${\text{\color{#FAF066}︶︶　\color{#FADC66} 𝗖lick on the images \color{#FABF66} below \color{#FAAE66}for my \color{#FCA049} 𝘀trawpage, \color{#FC7F49} 𝗮tabok,\color{#FC6149} and 𝗽rns.cc!　\color{#ED3434}︶︶}}$ <br> 
